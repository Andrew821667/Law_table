  ...
  if (role === 'ADMIN') {
    menu
      ...
      .addSubMenu(ui.createMenu('⚙️ Обработка и синхронизация')
        ...
        .addSeparator()
        .addItem('⏰ Включить авто-уведомления о заседаниях', 'setupAutomaticHearingNotifications')
        .addItem('🔕 Отключить авто-уведомления', 'removeAutomaticHearingNotifications')
      )
      .addSeparator()
