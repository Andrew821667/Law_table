...
var TimeTracker = (function() {
   ...
   *
   * Создать или получить лист учёта времени работы юристов.
   * Если лист не существует, создаёт его с заголовками и форматированием.
   *
   * @return {Sheet} Объект листа "⏱️ Учёт времени"
   */
   ...
   * ✅ ИСПРАВЛЕНО Issue #31: JSDoc документация
   *
   * Инициализирует лист учёта времени с заголовками, форматированием и шириной колонок.
   *
   * @param {Sheet} sheet - Лист для инициализации
   * @return {void}
   */
   ...
   * ✅ ИСПРАВЛЕНО Issue #31: JSDoc документация
   *
   * Добавляет новую запись времени работы через 4-шаговый мастер:
   * 1. Выбор дела (из назначенных или ввод вручную)
   * 2. Количество часов
   * 3. Описание работы
   * 4. Ставка (стандартная для роли или индивидуальная)
   *
   * @return {void}
   */
